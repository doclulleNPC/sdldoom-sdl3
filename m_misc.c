...
#include <stdlib.h>
#include <ctype.h>
#include <stdint.h>	/* intptr_t: defaultvalue holds either an int or a char* */
...
typedef struct
{
    char*	name;
    int*	location;
    intptr_t	defaultvalue;		// small int, or a (char*) for string defaults
...
void M_LoadDefaults (void)
{
    ...
    for (i=0 ; i<numdefaults ; i++)
    {
	// Small magnitude => plain int default; otherwise it is a char*
	// string default and the location is really a (char **).
